...
export class BinanceService {
    ...
    async harmonicCypherPattern(interval: CandleChartInterval_LT = '1h', limit: number = 500): Promise<AnalyzeResult[]>
    {
        ...
        try {
            ...
            for (const symbolItem of symbols) {
                ...
                const chartResult: ChartResult[] = await this.calculatorHarminicPattern(futuresCandles);
    ...
    async calculatorHarminicPattern(futuresCandles: CustomCandle[]): Promise<ChartResult[]>
    {
